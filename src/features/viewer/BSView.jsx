      ...
      <div className="bs-view print-view">
        <div className="text-center">
          ...
          <div className="underline title">
            Balance Sheet as at 31st March, {this.props.data.year}
          </div>
        </div>
                    ...
                    <React.Fragment key={i}>
                      <div className="grid grid-cols-2">
                        ...
                        <div className="text-right">
                          {typeof this.props.data.BS.To[keyName] == "number"
                            ? formatCurrency(this.props.data.BS.To[keyName])
                            : ""}
                        </div>
                      </div>
                      {typeof this.props.data.BS.To[keyName] == "object" ? (
                        <React.Fragment>
                          {Object.keys(this.props.data.BS.To[keyName]).map(
                            (key, ind) => (
                              <div className="grid grid-cols-2" key={ind}>
                                <div className="text-left pl-4">
                                  {typeof this.props.data.BS.To[keyName][key] ==
                                  "number"
                                    ? this.props.data.BS.To[keyName][key] < 0
                                      ? "Less. "
                                      : ""
                                    : ""}
                                  {key}
                                ...
                                <div className="text-right pr-4">
                                  ...
                                  >
                                    {typeof this.props.data.BS.To[keyName][
                                      key
                                    ] == "number"
                                      ? formatCurrency(
                                          this.props.data.BS.To[keyName][key]
                                        )
                                      : ""}
                                  </span>
                                </div>
                          ...
                          <div className="grid grid-cols-2">
                            ...
                            <div className="text-right">
                              {formatCurrency(
                                getObjectSum(this.props.data.BS.To[keyName])
                              )}
                            </div>
                          </div>
                        </React.Fragment>
                  ...
                  return (
                    <React.Fragment key={i}>
                      <div className="grid grid-cols-2">
                        <div className="text-left underline">{keyName}</div>
                        <div className="text-right">
                          {typeof this.props.data.BS.By[keyName] == "number"
                            ? formatCurrency(this.props.data.BS.By[keyName])
                            : ""}
                        </div>
                      </div>
                      {typeof this.props.data.BS.By[keyName] == "object" ? (
                        <React.Fragment>
                          {Object.keys(this.props.data.BS.By[keyName]).map(
                            (key, ind) => (
                              <div className="grid grid-cols-2" key={ind}>
                                <div className="text-left pl-4">
                                  {typeof this.props.data.BS.By[keyName][key] ==
                                  "number"
                                    ? this.props.data.BS.By[keyName][key] < 0
                                      ? "Less. "
                                      : ""
                                    : ""}
                                  {key}
                                ...
                                <div className="text-right pr-4">
                                  <span
                                    className={
                                      Object.keys(
                                        this.props.data.BS.By[keyName]
                                      )[
                                        Object.keys(
                                          this.props.data.BS.By[keyName]
                                        ).length - 1
                                      ] === key
                                        ? "inline-block accounting-col border-2 border-t-0 border-l-0 border-r-0 border-current"
                                        : ""
                                    }
                                  >
                                    {typeof this.props.data.BS.By[keyName][
                                      key
                                    ] == "number"
                                      ? formatCurrency(
                                          this.props.data.BS.By[keyName][key]
                                        )
                                      : ""}
                                  </span>
                                </div>
                          ...
                          <div className="grid grid-cols-2">
                            ...
                            <div className="text-right">
                              {formatCurrency(
                                getObjectSum(this.props.data.BS.By[keyName])
                              )}
                            </div>
                          </div>
                        </React.Fragment>
            ...
            <div className="grid grid-cols-2">
                ...
                <div className="grid grid-cols-2">
                  ...
                  <div className="text-right">
                    <span className="accounting-col border-2 border-l-0 border-r-0 border-current">
                      {formatCurrency(getObjectSum(this.props.data.BS.To))}
                    </span>
                  </div>
                </div>
              </div>
              <div className="px-1">
                <div className="grid grid-cols-2">
                  ...
                  <div className="text-right">
                    <span className="accounting-col border-2 border-l-0 border-r-0 border-current">
                      {formatCurrency(getObjectSum(this.props.data.BS.By))}
                    </span>
                  </div>
                </div>
              </div>
