    ...
    render() {
        ...
        return (
            <div className="dropdown-container relative">
                ...
                <div className="dropdown-area absolute bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-2" ref={ref => (this.displayAreaRef = ref)}>
                    {isOpen && (
                        <div
                            className=""
